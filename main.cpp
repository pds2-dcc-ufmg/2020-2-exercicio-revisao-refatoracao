...
int main(){
	...
	Cliente cli1 ("Aristóteles","Avenida do Meio-Termo", "Athenas", "Ática", "384 a.C");
	...
	enc0.print();
	custN += enc0.calcularpreco();
	std::cout << endl;

	
	enc1.print();
	custN += enc1.calcularpreco();
	std::cout << endl;

	
	enc2.print();
	custN += enc2.calcularpreco();
	std::cout << endl;

	
	enc3.print();
	custN += enc3.calcularpreco();
	std::cout << endl;

	
	enc4.print();
	custN += enc4.calcularpreco();
	std::cout << endl;

	
	enc5.print();
	custR += enc5.calcularpreco();
	std::cout << endl;

	
	enc6.print();
	custR += enc6.calcularpreco();
	std::cout << endl;

	
	enc7.print();
	custR += enc7.calcularpreco();
	std::cout << endl;
