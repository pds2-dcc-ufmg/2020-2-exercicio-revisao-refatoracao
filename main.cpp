...
int main(){
	...
	encomenda0.calculaTotal();
	encomenda0.printEncomenda();
	custoNormal += encomenda0.calculaTotal();
	std::cout << endl;

	encomenda1.calculaTotal();
	encomenda1.printEncomenda();
	custoNormal += encomenda1.calculaTotal();
	std::cout << endl;

	encomenda2.calculaTotal();
	encomenda2.printEncomenda();
	custoNormal += encomenda2.calculaTotal();
	std::cout << endl;

	encomenda3.calculaTotal();
	encomenda3.printEncomenda();
	custoNormal += encomenda3.calculaTotal();
	std::cout << endl;

	encomenda4.calculaTotal();
	encomenda4.printEncomenda();
	custoNormal += encomenda4.calculaTotal();
	std::cout << endl;

	encomenda5.calculaTotal();
	encomenda5.printEncomenda();
	custoRelampago += encomenda5.calculaTotal();
	std::cout << endl;

	encomenda6.calculaTotal();
	encomenda6.printEncomenda();
	custoRelampago += encomenda6.calculaTotal();
	std::cout << endl;

	encomenda7.calculaTotal();
	encomenda7.printEncomenda();
	custoRelampago += encomenda7.calculaTotal();
	std::cout << endl;
