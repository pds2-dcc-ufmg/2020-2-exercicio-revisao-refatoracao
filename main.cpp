...
int main(){
	...
	Cliente cli0 = ("Thales", "Rua dos Pré-Socráticos",
  "Miletus", "Ionia", "548 a.C.");

	Cliente cli1 = ("Aristóteles", "Avenida do Meio-Termo",
  "Atenas", "Ática", "348 a.C.");

	Cliente cli2 = ("Platão", "Praça das Formas", "Atenas",
  "Ática", "348 a.C.");

	Cliente cli3 = ("Sócrates", "Rua do Elenchus", "Atenas",
  "Ática", "399 a.C.");

	Cliente cli4 = ("Pitágoras", "Praça dos Quadarados dos catetos", "Samos", "Egeu", "571 a.C.");
	...
	EncomendaNormal enc1 = (10, 12, cli1, cli0);
	quantN++;
