...
int main(){
  ...
  Cliente cli1("Aristóteles", "Avenidade do Meio-Termo", "Atenas", "Ática", " 84 a.C");

  Cliente cli2("Platão", "Praça das Formas", "Atenas", "Ática", "348 a.C");

 Cliente cli3("Sócrates", "Rua do Elenchus", "Rua do Elenchus", "Atenas", "Ática", "399 a.C");
 ...
 Cliente cli4("Pitágoras", "Praça dos Quadrados dos Catetos", "Samos", "Egeu", "571 a.C");
  ...
  Cliente cli7("Anaxágoras", "Avenidad da Mente Cósmica", "Clazômenas", "Jónia", "499 a.C");
