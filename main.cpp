...
int main()
{
	...
	Cliente cli3("Sócrates", "Rua do Elenchus", "Atenas", "Ática", "384 a.C.");
	...
	EncomendaRelampago enc5(13, 18, taxa, cli5, cli6);
	quantN++;

	EncomendaRelampago enc6(6, 18, taxa, cli6, cli7);
	quantN++;

	EncomendaRelampago enc7(8, 18, taxa, cli7, cli0);
	quantN++;
